            ...
            <div class="col-md-9 col-sm-8">
                ...
                <div id="account-id">
                    ...
                    <div class="account-form">
                        <form action="{{ route('account.update', $user->id) }}" role="form" method="post" >
                            @csrf
                            @method('PUT')                                           
                            <ul class="form-list row">
                                <li class="col-md-6 col-sm-6">
                                    <label >Tền người dùng <em>*</em></label>
                                    <input name="name" type="text" class="input-text" value="{{ Auth::user()->name }}">
                                </li>
                                <li class="col-md-6 col-sm-6">
                                    <label >Email <em>*</em></label>
                                    <input name="email" type="text" class="input-text" value="{{ Auth::user()->email }}">
                                </li>                                                
                                <li class="col-md-6 col-sm-6">
                                    <label >Số điện thoại <em>*</em></label>
                                    <input name="phone" type="text" class="input-text" value="{{ Auth::user()->phone }}">
                                </li>
                                <li class="col-md-6 col-sm-6">
                                    <label>Địa chỉ</label>
                                    <input name="address" type="text" class="input-text" value="{{ Auth::user()->address }}">
                                </li>
                            </ul>
